...
print("Mean,Median,Mode is ".format(reading_mean,reading_median,reading_mode))
print("Mean,Median,Mode is".format(writing_mean,writing_median,writing_mode))
...
print("{}% of data for reading lies within 1 standard deviations".format(len(reading_list_of_data_within_1_std_deviation)*100.0/len(reading_list)))
